...
LOCAL_MODEL_PATH = "insurance_model.pkl"
...
class InferenceClient:
    ...
    def initialize(self):
        ...
        try:
            ...
            print("Preprocessing pipeline not found. Please copy it from treatment provider.")
            self.preprocessor = None
        ...
        with self.lock:
            ...
            try:
                ...
                return {
                    ...
                    "confidence": "This is a simple linear model prediction"
                }
...
def predict():
    ...
    result = client.predict_billing(patient_data, treatment_data)
    return jsonify(result)

@app.route('/model/refresh', methods=['GET'])
def refresh_model():
    success = client.fetch_model()
    return jsonify({
        "success": success,
