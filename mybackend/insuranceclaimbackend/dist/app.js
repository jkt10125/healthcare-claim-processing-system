...
function createClaim(contract, claimDetails) {
    return __awaiter(this, void 0, void 0, function* () {
        yield contract.submitTransaction('CreateClaim', claimDetails.claimID, claimDetails.treatmentID, claimDetails.patientID, claimDetails.aadharNumber, claimDetails.insuranceNumber, claimDetails.status);
    });
}
function readClaim(contract, claimID) {
    return __awaiter(this, void 0, void 0, function* () {
        const resultBytes = yield contract.evaluateTransaction('ReadClaim', claimID);
        return JSON.parse(utf8Decoder.decode(resultBytes));
    });
}
function updateClaim(contract, claimDetails) {
    return __awaiter(this, void 0, void 0, function* () {
        yield contract.submitTransaction('UpdateClaim', claimDetails.claimID, claimDetails.treatmentID, claimDetails.patientID, claimDetails.aadharNumber, claimDetails.insuranceNumber, claimDetails.status);
    });
}
function deleteClaim(contract, claimID) {
    return __awaiter(this, void 0, void 0, function* () {
        yield contract.submitTransaction('DeleteClaim', claimID);
    });
}
function getAllClaims(contract) {
    return __awaiter(this, void 0, void 0, function* () {
        const resultBytes = yield contract.evaluateTransaction('GetAllClaims');
        return JSON.parse(utf8Decoder.decode(resultBytes));
    });
}
// Express Routes
app.post('/claims', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const gateway = yield getGatewayClient();
        const network = gateway.getNetwork(channelName);
        const contract = network.getContract(chaincodeName);
        yield createClaim(contract, req.body);
...
app.get('/claims/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const gateway = yield getGatewayClient();
        const network = gateway.getNetwork(channelName);
        const contract = network.getContract(chaincodeName);
        const claim = yield readClaim(contract, req.params.id);
...
app.put('/claims/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const gateway = yield getGatewayClient();
        const network = gateway.getNetwork(channelName);
        const contract = network.getContract(chaincodeName);
        yield updateClaim(contract, Object.assign({ claimID: req.params.id }, req.body));
...
app.delete('/claims/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const gateway = yield getGatewayClient();
        const network = gateway.getNetwork(channelName);
        const contract = network.getContract(chaincodeName);
        yield deleteClaim(contract, req.params.id);
...
app.get('/claims', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const gateway = yield getGatewayClient();
        const network = gateway.getNetwork(channelName);
        const contract = network.getContract(chaincodeName);
        const claims = yield getAllClaims(contract);
